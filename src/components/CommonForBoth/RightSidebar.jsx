          ...
          <div data-simplebar className="h-100">
            ...
            <div className="p-4">
              <div className="radio-toolbar">
                <span className="mb-2 d-block">طرح بندی ها</span>
                <input
                  type="radio"
                  id="radioVertical"
                  name="radioFruit"
                ...
                />
                <label htmlFor="radioHorizontal">افقی</label>
              </div>

              <hr className="mt-1" />
              <div className="radio-toolbar">
                <span className="mb-2 d-block">حالت چیدمان</span>
                <input
                  type="radio"
                  id="radioLight"
                  name="radioLight"
                ...
                />
                <label htmlFor="radioDark">تاریک</label>
              </div>
              ...
              <div className="radio-toolbar">
                ...
                />
                <label htmlFor="radioscrollable">قابل پیمایش</label>
              </div>
              <hr className="mt-1" />
              ...
              {props.layoutType === "vertical" ? (
                <React.Fragment>
                  ...
                  <div className="radio-toolbar coloropt-radio">
                    <span className="mb-2 d-block" id="radio-title">
                      گزینه های رنگ نوار کناری سمت چپ
                    </span>
                    <Row>
                      <Col>
                        <input
                  ...
                  <div className="radio-toolbar imgopt-radio">
                    <span className="mb-2 d-block" id="radio-bgimg">
                      نوار کناری سمت چپ تصویر پس زمینه
                    </span>
                      ...
                      <label htmlFor="leftsidebarThemenone">
                        <div style={{ width: "40px", height: "80px" }}>
                          <div className="bg-light border px-2 h-100 shadow-none">
                            <div className="verticalcontent">هیچکدام</div>
                          </div>
                        </div>
                      </label>
                      {"   "}
              ...
              <h6 className="text-center">انتخاب چیدمان</h6>

              <div className="mb-2">
                <Link
                  to="//Avatar web-v-light.react.Avatar web.com"
                  target="_blank"
                >
                  <img
                    src={layout1}
              ...
              <div className="mb-2">
                <Link
                  to="//Avatar web-v-dark.react.Avatar web.com"
                  target="_blank"
                >
                  <img
                    src={layout2}
              ...
              <div className="mb-2">
                <Link
                  to="//Avatar web-v-rtl.react.Avatar web.com"
                  target="_blank"
                >
                  <img
                    src={layout3}
              ...
              <Link
                to="//1.envato.market/Avatar webreact"
                className="btn btn-primary btn-block mt-3"
                target="_blank"
              >
                <i className="mdi mdi-cart ms-1" /> هم اکنون بخرید
              </Link>
            </div>
          </div>
        </SimpleBar>
