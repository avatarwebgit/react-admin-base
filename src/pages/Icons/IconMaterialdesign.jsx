...
const IconMaterialdesign = () => {
  ...
  //meta title
  document.title = "Material Design | Avatar web ";

  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="آیکن ها" breadcrumbItem="MDI" />

          <Row className="icons-demo-content">
            <Col xs="12">
              <Card>
                <CardBody>
                  <h4 className="card-title">آیکون های جدید</h4>
                  <p className="card-title-desc mb-2">
                    استفاده کنید{" "}
                    <code>
                      &lt;i className="mdi mdi speedometer slow"&gt;&lt;/i&gt;
                    </code>{" "}
                    <Badge color="success">نسخه 5.8.55</Badge>.{" "}
              ...
              <Card>
                <CardBody>
                  <h4 className="card-title mb-4">تمام آیکون ها</h4>
          ...
          <Row>
            <Col xs="12">
              <Card>
                <CardBody>
                  <h4 className="card-title">اندازه</h4>
          ...
          <Row>
            <Col xs="12">
              <Card>
                <CardBody>
                  <h4 className="card-title">چرخش</h4>
