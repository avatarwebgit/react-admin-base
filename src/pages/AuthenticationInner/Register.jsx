...
const Register = () => {
  //meta title
  document.title = "Register | Avatar web ";
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={8} xl={5}>
                  ...
                  <Row>
                    <Col className="col-7">
                      <div className="text-primary p-4">
                        ...
                        <p>اکنون حساب رایگان Avatar web خود را دریافت کنید</p>
                      </div>
                    </Col>
                ...
                <CardBody className="pt-0">
                  ...
                  <div className="p-2">
                    ...
                    >
                      ...
                      <div className="mt-4 text-center">
                        <p className="mb-0">
                          با ثبت نام با Avatar web موافقت می کنید{" "}
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  © {new Date().getFullYear()} Avatar web. ساخته شده با{" "}
