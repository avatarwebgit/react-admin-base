...
const ProjectsList = () => {
  //meta title
  document.title = "Project List | Avatar web - قالب مدیریتی و داشبورد react";
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      color: Yup.string().required("لطفا رنگ خود را وارد کنید"),
    }),
    onSubmit: (values) => {
      if (isEdit) {
        const updateProject = {
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="پروژه ها" breadcrumbItem="فهرست پروژه ها" />
          <Row>
            <Col lg="12">
              <div>
                {isLoading ? (
                      ...
                      <Card>
                        <CardBody>
                          <TableContainer
                            ...
                            SearchPlaceholder="9 ردیف..."
                            buttonClass="btn btn-success btn-rounded"
                            buttonName=" افزودن پروژه جدید"
                  ...
                  <Col xs={12}>
                    ...
                    <div className="mb-3">
                      ...
                      >
                        ...
                        <option>به تاخیر انداختن</option>
                      </Input>
                      {validation.touched.status && validation.errors.status ? (
                        <FormFeedback type="invalid">
