            ...
            <div className="d-flex">
              <div>
                <h4 className="card-title mb-3">
                  دوستان خود را به Avatar web دعوت کنید
                </h4>
                <p className="text-muted">
                  اتفاقات جالب و هیجان انگیز فرصت های شغلی جذاب و مهم . با دعوت
                  کردن دوستان خود فرصت های شگفت انگیز را به انها معرفی کنید
                </p>
                <div>
                    ...
                    <div className="bg-light p-3 d-flex mb-3 rounded">
                      ...
                      <div className="flex-grow-1">
                        <h5 className="font-size-15 mb-2">
                          ...
                          <span className="badge badge-soft-info">فریلنسر</span>
                        </h5>
