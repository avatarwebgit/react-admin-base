...
import { addDiscount } from '../../../store/e-commerce/actions';

const CreateDiscountModal = ({ isOpen, toggle }) => {
   ...
   <Container fluid>
    <Row>
     <Col xs='12'>
      <Card>
       <CardBody>
        <CardTitle tag='h4'>اطلاعات تخفیف</CardTitle>
