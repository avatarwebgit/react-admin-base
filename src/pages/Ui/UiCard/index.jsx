...
const UiCards = () => {
  //meta title
  document.title = "Cards | Avatar web ";

  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="المنت های UI" breadcrumbItem="کارت ها" />
          <BasicCard />
          <Row>
            <Col md={6}>
              <CardTitleTreatment text="" />
            </Col>
            <Col md={6}>
              <CardTitleTreatment text="" />{" "}
            </Col>
          ...
          <Row>
            ...
            <Col lg={4}>
              <CardTitleTreatment text="text-center" />
            </Col>
            <Col lg={4}>
              <CardTitleTreatment text="text-end" />
            </Col>
          </Row>
