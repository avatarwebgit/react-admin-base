  ...
  return (
    <React.Fragment>
      <Row>
        <Col md={6} xl={3}>
          <Card>
            <CardImg top className="img-fluid" src={img1} alt="Avatar web" />
            <CardBody>
        ...
        <Col md={6} xl={3}>
          <Card>
            <CardImg top className="img-fluid" src={img2} alt="Avatar web" />
            <CardBody>
              <CardTitle className="mt-0">عنوان کارت</CardTitle>
              <CardText>
        ...
        <Col md={6} xl={3}>
          <Card>
            <CardImg top className="img-fluid" src={img3} alt="Avatar web" />
            <CardBody>
              <CardText>
                چند نمونه متن کوتاه برای ساختن عنوان کارت و آرایش بخش عمده ای از
                کارت
        ...
        <Col md={6} xl={3}>
          <Card>
            ...
            <CardImg className="img-fluid" src={img4} alt="Avatar web" />
            <CardBody>
              <CardText>
                چند نمونه متن کوتاه برای ساختن عنوان کارت و آرایش بخش عمده ای از
                کارت
