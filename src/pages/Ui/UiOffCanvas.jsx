...
const UiDrawer = () => {
  //meta title
  document.title = "OffCanvas | Avatar web ";
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    از دکمه های زیر برای نمایش و پنهان کردن یک عنصر offcanvas از
                    طریق جاوا اسکریپت استفاده کنید که <code>.show</code> را
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    ...
                    <Offcanvas isOpen={open} toggle={toggleLeftCanvas}>
                      ...
                      <OffcanvasBody>
                        <div>
                          برخی از متن ها به عنوان جایگیر. در زندگی واقعی شما می
                          توانید داشته باشید عناصری که انتخاب کرده اید لایک،
                          متن، عکس، لیست ها و غیره
                        </div>
                        <UncontrolledDropdown className="mt-3">
                          ...
                          >
                            دکمه کشویی <i className="mdi mdi-chevron-down"></i>
                          </DropdownToggle>
                          <DropdownMenu>
                            <li>
            ...
            <Col lg={12}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    کلاس‌های پاسخگو منوی کشویی برای هر کدام در دسترس هستند نقطه
                    شکست
                  </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    ویژگی <code>data bs scroll</code> برای جابجایی استفاده کنید
                  ...
                  >
                    ...
                    <OffcanvasBody>
                      <p>
                        سعی کنید بقیه صفحه را اسکرول کنید تا این گزینه را ببینید
                        در عمل
                      </p>
                    </OffcanvasBody>
                  </Offcanvas>
