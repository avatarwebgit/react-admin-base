...
const UiPlaceholders = () => {
  //meta title
  document.title = "Placeholders | Avatar web ";
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    برای ایجاد «بارگیری» اعمال می‌شوند، دوباره ایجاد کنید کارت».
                    اندازه و نسبت بین این دو یکسان است
                  </p>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ایجاد متغیرهایی با <code>.placeholder</code> کلاس و یک کلاس
                    ستون شبکه (به عنوان مثال، <code>.col-6</code>) برای تنظیم{" "}
                    <code>عرض</code>. آنها می توانند متن را جایگزین کنند داخل یک
                    عنصر یا به عنوان یک کلاس اصلاح کننده به یک اضافه شود جزء
                    موجود
                  </p>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    متغیرهایی را با <code>.placeholder-glow</code> متحرک کنید یا{" "}
                    <code>.placeholder-wave</code> برای انتقال بهتر درک چیزی که{" "}
                    <em>فعال</em> بارگذاری می شود
                  </p>
