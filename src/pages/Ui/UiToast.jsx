...
const UiToast = () => {
  //meta title
  document.title = "Toast | Avatar web ";
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-des">
                    روی دکمه زیر کلیک کنید تا توست را نشان دهید (موقعیت ما آب و
                    برق در گوشه سمت راست پایین) که به طور پیش فرض پنهان شده است
                  </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    توست به اندازه نیاز شما انعطاف پذیر است و بسیار کم است نشانه
                    گذاری مورد نیاز حداقل به یک عنصر واحد نیاز داریم حاوی محتوای
                    «برشته شده» شما باشد و قویاً الف دکمه رد کردن
                  </p>
                  ...
                  <div style={{ minHeight: "110px" }}>
                    <Toast isOpen={toast2} role="alert">
                      ...
                      >
                        ...
                        <strong className="me-auto">Avatar web</strong>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    توست ها نیز کمی شفاف هستند، بنابراین با هم مخلوط می شوند هر
                    چه ممکن است در آن ظاهر شوند. برای مرورگرهایی که پشتیبانی می
                    کنند ویژگی <code>فیلتر پس زمینه</code> CSS را نیز انجام
                    خواهیم داد سعی کنید عناصر زیر نان تست را محو کنید
                  </p>
                    ...
                    >
                      <div className="toast-container position-absolute top-0 end-0 p-2 p-lg-3">
                        ...
                        <Toast isOpen={toast5} role="alert">
                          ...
                          <ToastBody>
                            مراقب باشید، توست ها به طور خودکار روی هم چیده می
                            شوند
                          </ToastBody>
                        </Toast>
                      </div>
