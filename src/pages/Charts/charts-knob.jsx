...
const ChartsKnob = () => {
  //meta title
  document.title =
    "Jquery Knob Charts | Avatar web - قالب مدیریتی و داشبورد react";
              ...
              <Card>
                <CardBody>
                  ...
                  <Row>
                    ...
                    <Col lg="4">
                      <div className="text-center" dir="ltr">
                        <h5 className="font-size-14 mb-3">نمایش مقدار قبلی</h5>
                        <Knob
                          value={value_prev}
                          height={200}
                          width={150}
                  ...
                  <Row>
                    ...
                    <Col lg="4">
                      <div className="text-center" dir="ltr">
                        <h5 className="font-size-14 mb-3">افست زاویه و قوس</h5>
                        <Knob
