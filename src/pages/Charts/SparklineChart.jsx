...
const SparklineChart = () => {
  //meta title
  document.title =
    "Sparkline Charts | Avatar web - قالب مدیریتی و داشبورد react";
    ...
    <React.Fragment>
      <div className="page-content">
        <div className="container-fluid">
          {/* Render Breadcrumb */}
          <Breadcrumbs title="نمودارها" breadcrumbItem="نمودارهای جرقه ای" />

          <Row>
            <Col sm={4}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">نمودار نقاط</CardTitle>
                  <Sparklines
                    height={100}
          ...
          <Row>
            <Col sm={4}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">نمودار میله ای مرکب</CardTitle>
                  <Sparklines
                    height={100}
            ...
            <Col sm={4}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">نمودار خط مرجع</CardTitle>
                  <Sparklines
                    height={100}
                    data={[
            ...
            <Col sm={4}>
              <Card className="bg-success mb-4">
                <CardBody>
                  <CardTitle className="mb-4">نمودار دنیای واقعی</CardTitle>
                  <Sparklines
                    height={80}
                    data={[
          ...
          <Row>
            <Col sm={4}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">باند معمولی</CardTitle>
                  <Sparklines
                    height={100}
                    data={[5, 10, 5, 20, 18, 17, 29, 10, 18]}
                  >
