...
const CandidateOverview = () => {
  document.title = "Candidate Overview | Avatar web ";
  return (
    <React.Fragment>
                ...
                <CardBody>
                  <div className="text-center mb-4">
                    ...
                    <div className="mx-auto">
                      <span className="badge me-1 text-bg-info">فریلنسر</span>
                      <span className="badge me-1 text-bg-success">فعال</span>
                      <span className="badge me-1 text-bg-warning">
                        ادوبی XD
                      </span>
                      <span className="badge me-1 text-bg-warning">فیگما</span>
