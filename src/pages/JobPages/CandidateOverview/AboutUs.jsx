        ...
        <Card>
          <CardBody>
            ...
            <p className="text-muted">
              ...
              سریع را مشخص کنید. صبر. صبر بی نهایت بدون میانبر حتی اگر مشتری بی
              توجه باشد. چند نمونه متن کوتاه برای ساخت بر روی عنوان کارت و حجم
              دادن به محتوای کارت Moltin پلتفرمی را در اختیار شما قرار می دهد
            </p>
            ...
            <ul className="verti-timeline list-unstyled">
                  ...
                  <div className="flex-grow-1">
                    <div>
                      ...
                      <p className="text-muted mb-0">
                        انواع مختلفی از معابر موجود وجود دارد، اما اکثریت تغییر
                        به نوعی. به عنوان یک بسیار توسعه و طراحی محصول ماهر و
                        موفق متخصص با بیش از 4 سال تجربه من
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <li className="event-list">
                ...
                <div className="d-flex">
                  <div className="flex-grow-1">
                    <div>
                      <h6 className="font-size-14 mb-1">طراحی ارتباط تصویری</h6>
                      <p className="text-muted">
              ...
              <CardBody>
                <div className="d-flex">
                  ...
                  <div className="flex-grow-1 overflow-hidden">
                    <h5 className="text-truncate font-size-15">
                      <Link to="#" className="text-dark">
                        رابط کاربری داشبورد Avatar web
                      </Link>
                    </h5>
              ...
              <CardBody className="border-bottom">
                ...
                <div className="hstack gap-2">
                  ...
                  <Link to="#!" className="btn btn-soft-info">
                    <i className="bx bxl-twitter align-middle me-1"></i> توییتر
                  </Link>
                  ...
                  <Link to="#!" className="btn btn-soft-success">
                    <i className="bx bxl-whatsapp align-middle me-1"></i> واتساب
                  </Link>
                </div>
              </CardBody>
            </Card>
