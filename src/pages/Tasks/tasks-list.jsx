...
const TasksList = () => {
  //meta title
  document.title = "Task List | Avatar web ";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="وظایف" breadcrumbItem="لیست وظایف" />
          {/* Render Breadcrumbs */}
          <Row>
            <Col lg={8}>
                              ...
                              <tr key={index}>
                                        ...
                                        <Link to="#" className="d-inline-block">
                                          {userImg.img ? (
                                            ...
                                            <div className="avatar-xs">
                                              <span
                                                className={`avatar-title rounded-circle ${card.imageTextColor} text-white font-size-16`}
                                              >
                                                {userImg.imageText}
                                              </span>
                                            </div>
                                ...
                                <td>
                                  <div className="text-center">
                                    <span
                                      className={`badge rounded-pill badge-soft-${card.badgeColor} font-size-11`}
                                    >
                                      {card.badgeText}
                                    </span>
                                  </div>
            ...
            <Col lg={4}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-3">تسک ها </CardTitle>
                  <ReactApexChart
                    options={options}
                    series={series}
                    type="line"
              ...
              <Card>
                <CardBody>
                  <h4 className="card-title mb-4">تسک های اخیر</h4>
                                ...
                                {item.avatars.map((avatarImg, inx) => (
                                  <div className="avatar-group-item" key={inx}>
                                    {avatarImg.src ? (
                                      ...
                                      <div className="avatar-xs">
                                        <span
                                          className={`avatar-title rounded-circle ${avatarImg.bgColor} text-white font-size-16`}
                                        >
