...
export const setFolderOnSelectedMails = (
  selectedmails,
  folderId,
  activeTab
) => ({
...
export const onGetMailSettingsSuccess = (data) => ({
  type: GET_MAIL_SETTINGS_SUCCESS,
  payload: data,
});
...
export const updateMailSettingsFail = () => ({
  type: UPDATE_MAIL_SETTINGS_FAIL,
});
