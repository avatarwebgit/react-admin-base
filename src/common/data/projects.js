...
const projects = [
  {
    ...
    files: [
      { name: "Avatar web Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Avatar web Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Avatar web Logo.Zip", size: "2.02 MB", link: "#" },
...
const projectListData = [
  ...
  },
  {
    id: 5,
    img: companies05,
    name: "رابط کاربری داشبورد Avatar web",
    description: "وجود جداگانه کمی غیر منطقی است",
    dueDate: "22 دی, 19",
    status: "تکمیل شده",
    color: "success",
